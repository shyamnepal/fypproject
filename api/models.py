...
class Hotels(models.Model):
    ...
    hotelID=models.UUIDField(primary_key=True,default=uuid.uuid4,editable=False)
...
class Rooms_info(models.Model):
    ...
    room_number =models.UUIDField(primary_key=True,default=uuid.uuid4,editable=False)
